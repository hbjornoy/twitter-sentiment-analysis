...
def indicate_number(corpus):
    ...
    Input: 
        corpus:A corpus
    Output: 
        new_corpus: A corpus, where every line that contains a number ends with "Thereisanumber". 
    """
    new_corpus=[]
    for line in corpus:
...
def corpus_to_strings(original_corpus):
    """ 
    Input: 
        original_corpus:A corpus on 'normal' format: a list of binary strings
    Output: 
        corpus:A corpus on string format: a list of strings
    """
    corpus=[]
...
def compare_set_char(neg_counter,pos_counter,characters):
    ...
    Ouput: 
        For each character; Prints information about how many percentage of the character was found in 
...
def compare_sets(words,vec_pos,vec_neg):
    ...
    Output: 
        For each word; Prints information about how many percentage of the word was found in 
